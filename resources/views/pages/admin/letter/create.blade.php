                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="letter_type" class="form-control" required>
                                            ...
                                            <option value="Surat Peminjaman Recovery" {{ (old('letter_type') == 'Surat Peminjaman Recovery')? 'selected':'' }}>Surat Peminjaman Recovery</option>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control @error('tanggal_kembali') is-invalid @enderror" value="{{ old('tanggal_kembali') }}" name="tanggal_kembali" >
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    <label for="date_received" class="col-sm-3 col-form-label">Nama Nasabah</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('date_received') is-invalid @enderror" value="{{ old('date_received') }}" name="date_received" required>
                                    </div>
                                    @error('date_received')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    <label for="regarding" class="col-sm-3 col-form-label">CIF</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('regarding') is-invalid @enderror" value="{{ old('regarding') }}" name="regarding" required>
                                    </div>
                                    @error('regarding')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    <label for="ld" class="col-sm-3 col-form-label">LD</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('ld') is-invalid @enderror" value="{{ old('ld') }}" name="ld" required>
                                    </div>
                                    @error('ld')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    <label for="perihal" class="col-sm-3 col-form-label">Dokumen</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control @error('perihal') is-invalid @enderror" value="{{ old('perihal') }}" name="perihal" placeholder="Nama Dokumen.." required></textarea>
                                    </div>
                                    @error('perihal')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    <label for="department_id" class="col-sm-3 col-form-label">Unit Kerja</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="letter_file" class="form-text">Ekstensi png/jpg/pdf | Kosongkan file jika tidak diisi</div>
                                    </div>
                                    @error('letter_file')
                                        <div class="invalid-feedback">
                                            {{ $message }}
