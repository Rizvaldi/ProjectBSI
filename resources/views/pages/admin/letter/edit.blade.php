                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('date_received') is-invalid @enderror" value="{{ $item->date_received }}" name="date_received" required>
                                    </div>
                                    @error('date_received')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('regarding') is-invalid @enderror" value="{{ $item->regarding }}" name="regarding" required>
                                    </div>
                                    @error('regarding')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('ld') is-invalid @enderror" value="{{ $item->ld }}" name="ld" required>
                                    </div>
                                    @error('ld')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control @error('perihal') is-invalid @enderror" value=""name="perihal"required>{{ $item->perihal }}</textarea>
                                    </div>  
                                    @error('perihal')
                                        <div class="invalid-feedback">
                                            {{ $message }}
